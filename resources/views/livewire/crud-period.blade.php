...
<div class="py-0 overflow-x-auto">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-2">
        <div class=" dark:bg-gray-700  overflow-hidden shadow-xl sm:rounded-lg px-3 py-3 mb-0">
            <h1 class="mt-2 text-center text-2xl font-bold text-white">Periodos</h1>
        </div>
    </div>
              ...
              <table class="w-full divide-y divide-gray-200 table-auto text-gray-500 dark:text-gray-400">
                  <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr class="text-left text-xs font-bold  uppercase">
                          ...
                          <td scope="col" class="px-6 py-3" align="center">Periodo</td>
                          <td scope="col" class="px-6 py-3" align="center">Inicio</td>
                          <td scope="col" class="px-6 py-3" align="center">Termina el...</td>
                          <td scope="col" class="px-6 py-3" align="center">Estado</td>
                  ...
                  <tbody class="divide-y divide-gray-200">
                      @foreach ($periods as $item)
                          <tr class="text-sm font-medium text-gray-900">
                              ...
                              <td class="px-6 py-4" align="center">{{ $item->dateinit }}</td>
                              <td class="px-6 py-4" align="center">{{ $item->dateout }}</td>
                              <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm" align="center">
                                  @if ($item->status == 0)
                                      <span
                              ...
                              <td class="px-6 py-4" align="center">
                                  ...
                                  <x-jet-button class="bg-green-500" wire:click="activePeriod({{ $item }})">
